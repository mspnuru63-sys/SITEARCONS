...
(function () {
  ...
  <div class="top-bar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <a href="mailto:contact@archivescongo.com" class="hidden sm:flex items-center gap-1">
          <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          contact@archivescongo.com
        </a>
      </div>
  ...
  <section class="newsletter-section py-20">
    <div class="max-w-2xl mx-auto px-4 text-center relative z-10">
      <h3 class="text-3xl md:text-4xl font-bold text-white mb-3"> Abonnez - vous</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-14">
          ...
          <div class="lg:col-span-3">
            ...
            <ul class="space-y-4 text-sm text-white/50">
              ...
              <li>+242 06 730 44 41</li>
              <li>contact@archivescongo.com</li>
              <li> </li>
            </ul>
          </div>
        </div>
